...
import StaticContentListComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/eContentOperationComponent/aStaticContentComponent/aListComponent";
...
const StaticContentListPage = () => {
  // Variable
	const socket = useSocket();
  const listAPIResponse = staticContentAPIEndpoint.useStaticContentListAPIQuery(null);
  ...
  useSocketEventHook(socket, {
    STATICCONTENT_LISTED: () => apiCall.listAPIResponse.refetch()
  })
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.staticContent, "List") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* StaticContentListPage */}
