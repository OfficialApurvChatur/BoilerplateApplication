...
import ImageStorageRetrieveComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/dFileStorageComponent/aImageStorageComponent/cRetrieveComponent";
...
const ImageStorageRetrievePage = () => {
  // Variable
  const { id } = useParams();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.imageStorage, "Retrieve") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* ImageStorageRetrievePage */}
...
export default ImageStorageRetrievePage;
