...
import PermissionListComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/bUserAdministrationComponent/cPermissionComponent/aListComponent";
...
const PermissionListPage = () => {
  ...
  const listAPIResponse = permissionAPIEndpoint.usePermissionListAPIQuery(null);
  ...
  useSocketEventHook(socket, {
    PERMISSION_LISTED: () => apiCall.listAPIResponse.refetch()
  })
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.permission, "List") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* PermissionListPage */}
