...
import AccountListComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/bUserAdministrationComponent/gAccountComponent/aListComponent";
...
const AccountListPage = () => {
  ...
  const listAPIResponse = accountAPIEndpoint.useAccountListAPIQuery(null);
  ...
  useSocketEventHook(socket, {
    ACCOUNT_LISTED: () => apiCall.listAPIResponse.refetch()
  })
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.account, "List") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* AccountListPage */}
