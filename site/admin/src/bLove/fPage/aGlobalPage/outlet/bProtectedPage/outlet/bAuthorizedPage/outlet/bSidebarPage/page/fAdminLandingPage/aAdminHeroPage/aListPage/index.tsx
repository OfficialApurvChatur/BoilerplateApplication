...
import AdminHeroListComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/fAdminLandingComponent/aAdminHeroComponent/aListComponent";
...
const AdminHeroListPage = () => {
  // Variable
	const socket = useSocket();
  const listAPIResponse = adminHeroAPIEndpoint.useAdminHeroListAPIQuery(null);
  ...
  useSocketEventHook(socket, {
    ADMINHERO_LISTED: () => apiCall.listAPIResponse.refetch()
  })
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.adminHero, "List") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* AdminHeroListPage */}
