...
import SignUpRetrieveComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/cUserAuthenticationComponent/bSignUpComponent/cRetrieveComponent";
...
const SignUpRetrievePage = () => {
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.signUp, "Retrieve") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* SignUpRetrievePage */}
...
export default SignUpRetrievePage;
