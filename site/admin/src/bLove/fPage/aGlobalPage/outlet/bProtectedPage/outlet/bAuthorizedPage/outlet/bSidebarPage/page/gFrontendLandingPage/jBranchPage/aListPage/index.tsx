...
import BranchListComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/gFrontendLandingComponent/jBranchComponent/aListComponent";
...
const BranchListPage = () => {
  ...
  const listAPIResponse = branchAPIEndpoint.useBranchListAPIQuery(null);
  ...
  useSocketEventHook(socket, {
    BRANCH_LISTED: () => apiCall.listAPIResponse.refetch()
  })
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.branch, "List") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* BranchListPage */}
      <BranchListComponent 
