...
import ProjectUpdateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/gFrontendLandingComponent/mProjectComponent/dUpdateComponent";
...
const ProjectUpdatePage = () => {
  ...
  const retrieveAPIResponse = projectAPIEndpoint.useProjectRetrieveAPIQuery({ params: { _id: id } });
  const [ updateAPITrigger, updateAPIResponse ] = projectAPIEndpoint.useProjectUpdateAPIMutation();
  ...
  useSocketEventHook(socket, {
    [`PROJECT_RETRIEVED:${id}`]: () => apiCall.retrieveAPIResponse.refetch()
  })  
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.project, "Update") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* ProjectUpdatePage */}
