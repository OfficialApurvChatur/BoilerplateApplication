...
import AdminAboutApplicationUpdateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/fAdminLandingComponent/cAdminAboutApplicationComponent/dUpdateComponent";
...
const AdminAboutApplicationUpdatePage = () => {
  // Variable
  const { id } = useParams();
  ...
  const [ updateAPITrigger, updateAPIResponse ] = adminAboutApplicationAPIEndpoint.useAdminAboutApplicationUpdateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.adminAboutApplication, "Update") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* AdminAboutApplicationUpdatePage */}
...
export default AdminAboutApplicationUpdatePage;
