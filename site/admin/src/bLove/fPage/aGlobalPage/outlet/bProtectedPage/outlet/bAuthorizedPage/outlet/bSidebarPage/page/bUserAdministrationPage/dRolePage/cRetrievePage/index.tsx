...
import RoleRetrieveComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/bUserAdministrationComponent/dRoleComponent/cRetrieveComponent";
...
const RoleRetrievePage = () => {
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.role, "Retrieve") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* RoleRetrievePage */}
