...
const BranchSectionComponent = (props: BranchSectionComponentType) => {
  ...
  const tabClass = (tab: TabKey) =>
    `tab flex flex-col justify-center items-center
    border-2 rounded-lg bg-gray-100 text-sm cursor-pointer transition-all
    ...
    <React.Fragment>
      ...
      <section id="counter" >
        <div className="bg-gradient-to-tl from-muted/100 via-muted/50 to-muted/0 p-6 sm:p-8">
          ...
          {/* Tabs */}
          <div className="p-4">
            <ul className="flex max-sm:flex-col gap-x-2 gap-y-4 w-max rounded-lg items">
              <li 
                id="homeTab"
            ...
            <div id="homeContent" className="tab-content w-11/13 block mt-8">
              <div className="bg-white p-4">
                <div className="max-w-6xl mx-auto">
                  <div className="text-center">
                    <h2 className="text-3xl font-bold text-slate-900 inline-block relative after:absolute after:w-4/6 after:h-1 after:left-0 after:right-0 after:-bottom-4 after:mx-auto after:bg-pink-400 after:rounded-md-full">LATEST BLOGS</h2>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-16 max-lg:max-w-3xl max-md:max-w-md mx-auto">
                    <div className="bg-white cursor-pointer rounded-md overflow-hidden [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)] relative top-0 hover:-top-2 transition-all duration-300">
                      <div className="bg-gray-50 aspect-[23/15]">
                        <img src="https://readymadeui.com/Imagination.webp" alt="Blog Post 1" className="w-full h-full object-cover object-top" />
                      </div>
                      <div className="p-6">
                        <span className="text-sm block text-slate-600 mb-2">10 FEB 2023 | BY JOHN DOE</span>
                        <h2 className="text-xl font-semibold text-slate-900">A Guide to Igniting Your Imagination</h2>
                        <hr className="my-4 border-slate-300" />
                        <p className="text-slate-600 text-[15px] leading-relaxed">Discover practical tips to unlock your creativity and bring fresh ideas to life—perfect for creators, designers, and innovators looking to spark inspiration.</p>
                      </div>
                    </div>

                    <div className="bg-white cursor-pointer rounded-md overflow-hidden [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)] relative top-0 hover:-top-2 transition-all duration-300">
                      <div className="bg-gray-50 aspect-[23/15]">
                        <img src="https://readymadeui.com/hacks-watch.webp" alt="Blog Post 2" className="w-full h-full object-cover object-top" />
                      </div>
                      <div className="p-6">
                        <span className="text-sm block text-slate-600 mb-2">7 JUN 2023 | BY MARK ADAIR</span>
                        <h3 className="text-xl font-semibold text-slate-900">Hacks to Supercharge Your Day</h3>
                        <hr className="my-4 border-slate-300" />
                        <p className="text-slate-600 text-[15px] leading-relaxed">Boost your productivity with simple, effective strategies to help you stay focused, energized, and motivated throughout the day.</p>
                      </div>
                    </div>

                    <div className="bg-white cursor-pointer rounded-md overflow-hidden [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)] relative top-0 hover:-top-2 transition-all duration-300">
                      <div className="bg-gray-50 aspect-[23/15]">
                        <img src="https://readymadeui.com/prediction.webp" alt="Blog Post 3" className="w-full h-full object-cover object-top" />
                      </div>
                      <div className="p-6">
                        <span className="text-sm block text-slate-600 mb-2">5 OCT 2023 | BY SIMON KONECKI</span>
                        <h3 className="text-xl font-semibold text-slate-900">Trends and Predictions</h3>
                        <hr className="my-4 border-slate-300" />
                        <p className="text-slate-600 text-[15px] leading-relaxed">Stay ahead of the curve with the latest insights into upcoming industry trends, emerging technologies, and what they mean for the future.</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div id="settingContent" className="tab-content w-11/13 hidden mt-8">
            ...
            <div id="profileContent" className="tab-content w-11/13 hidden mt-8">
            ...
            <div id="inboxContent" className="tab-content w-11/13 hidden mt-8">
            ...
            <div id="notificationContent" className="tab-content w-11/13 hidden mt-8">
