...
export type HeroModelType = DefaultSchemaUtilityType & {
  // Relation Info Type
}

const schema = new mongoose.Schema<HeroModelType>({
...
export const HeroModel = mongoose.model<HeroModelType>("HeroModel", schema);
