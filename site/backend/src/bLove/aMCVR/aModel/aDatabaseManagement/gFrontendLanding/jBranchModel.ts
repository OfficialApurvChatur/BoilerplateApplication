...
export type BranchModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<BranchModelType>({
...
} as mongoose.SchemaDefinition<BranchModelType> )
...
export const BranchModel = mongoose.model<BranchModelType>("BranchModel", schema);
