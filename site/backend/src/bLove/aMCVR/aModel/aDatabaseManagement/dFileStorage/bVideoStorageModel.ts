...
export type VideoStorageModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<VideoStorageModelType>({
...
export const VideoStorageModel = mongoose.model<VideoStorageModelType>("VideoStorageModel", schema);
