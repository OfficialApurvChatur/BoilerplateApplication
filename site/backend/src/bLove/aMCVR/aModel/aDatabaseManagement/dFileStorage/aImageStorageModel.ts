...
export type ImageStorageModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<ImageStorageModelType>({
...
export const ImageStorageModel = mongoose.model<ImageStorageModelType>("ImageStorageModel", schema);
