...
export type AdminAboutApplicationModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<AdminAboutApplicationModelType>({
...
export const AdminAboutApplicationModel = mongoose.model<AdminAboutApplicationModelType>("AdminAboutApplicationModel", schema);
