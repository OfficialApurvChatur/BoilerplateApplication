...
export type AdminBranchModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<AdminBranchModelType>({
...
} as mongoose.SchemaDefinition<AdminBranchModelType> )
...
export const AdminBranchModel = mongoose.model<AdminBranchModelType>("AdminBranchModel", schema);
