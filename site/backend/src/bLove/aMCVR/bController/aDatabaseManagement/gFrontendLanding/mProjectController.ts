...
const projectController = (Model=ProjectModel, Label="ProjectModel") => ({
  // List Controller
  list: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      cacheCreateMiddleware({ 
        key: cacheVariable.projectModel.list({ 
          Label
        }), 
        data: list 
  ...
  create: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.projectModel.create({ 
          Label  
        }), 
      })(request, response, next);
      ...
      eventCreateMiddleware({
        Label,
        data: create,
        eventList: eventVariable.projectModel.create({
          Label, 
        }),
      })(request, response, next);
      ...
      emailToCompanyMiddleware({
        Label,
        data: create,
        textMessage: emailToCompanyVariable.projectModel.create({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToUserMiddleware({
        Label,
        data: create,
        textMessage: emailToUserVariable.projectModel.create({
          Label, 
          request 
        }),
      })(request, response, next);
  ...
  retrieve: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Create Cache
      cacheCreateMiddleware({ 
        key: cacheVariable.projectModel.retrieve({ 
          Label, 
          request 
        }), 
        data: retrieve 
  ...
  update: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Delete Cache
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.projectModel.update({ 
          Label, 
          request 
        }), 
      })(request, response, next);
      ...
      eventCreateMiddleware({
        Label,
        data: update,
        eventList: eventVariable.projectModel.update({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToCompanyMiddleware({
        Label,
        data: update,
        textMessage: emailToCompanyVariable.projectModel.update({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToUserMiddleware({
        Label,
        data: update,
        textMessage: emailToUserVariable.projectModel.update({
          Label, 
          request 
        }),
      })(request, response, next);
  ...
  delete: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Delete Cache
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.projectModel.delete({ 
          Label, 
          request 
        }), 
      })(request, response, next);
      ...
      eventCreateMiddleware({
        Label,
        data: delete_object,
        eventList: eventVariable.projectModel.delete({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToCompanyMiddleware({
        Label,
        data: delete_object,
        textMessage: emailToCompanyVariable.projectModel.delete({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToUserMiddleware({
        Label,
        data: delete_object,
        textMessage: emailToUserVariable.projectModel.delete({
          Label, 
          request 
        }),
      })(request, response, next);
  ...
  listMini: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Create Cache
      cacheCreateMiddleware({ 
        key: cacheVariable.projectModel.listMini({ 
          Label
        }), 
        data: list 
      })(request, response, next);
