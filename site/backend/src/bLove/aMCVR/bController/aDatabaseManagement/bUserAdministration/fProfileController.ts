...
const profileController = (Model=ProfileModel, Label="ProfileModel") => ({
  // List Controller
  list: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      cacheCreateMiddleware({ 
        key: cacheVariable.profileModel.list({ 
          Label
        }), 
        data: list 
  ...
  create: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      emailToCompanyMiddleware({
        Label,
        data: create,
        textMessage: emailToCompanyVariable.profileModel.create({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToUserMiddleware({
        Label,
        data: create,
        textMessage: emailToUserVariable.profileModel.create({
          Label, 
          request 
        }),
      })(request, response, next);
  ...
  retrieve: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Create Cache
      cacheCreateMiddleware({ 
        key: cacheVariable.profileModel.retrieve({ 
          Label, 
          request 
        }), 
        data: retrieve 
  ...
  update: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Delete Cache
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.profileModel.update({ 
          Label, 
          request 
        }), 
      })(request, response, next);
      ...
      eventCreateMiddleware({
        Label,
        data: update,
        eventList: eventVariable.profileModel.update({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToCompanyMiddleware({
        Label,
        data: update,
        textMessage: emailToCompanyVariable.profileModel.update({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToUserMiddleware({
        Label,
        data: update,
        textMessage: emailToUserVariable.profileModel.update({
          Label, 
          request 
        }),
      })(request, response, next);
  ...
  delete: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Delete Cache
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.profileModel.delete({ 
          Label, 
          request 
        }), 
      })(request, response, next);
      ...
      eventCreateMiddleware({
        Label,
        data: delete_object,
        eventList: eventVariable.profileModel.delete({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToCompanyMiddleware({
        Label,
        data: delete_object,
        textMessage: emailToCompanyVariable.profileModel.delete({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToUserMiddleware({
        Label,
        data: delete_object,
        textMessage: emailToUserVariable.profileModel.delete({
          Label, 
          request 
        }),
      })(request, response, next);
  ...
  listMini: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Create Cache
      cacheCreateMiddleware({ 
        key: cacheVariable.profileModel.listMini({ 
          Label
        }), 
        data: list 
      })(request, response, next);
