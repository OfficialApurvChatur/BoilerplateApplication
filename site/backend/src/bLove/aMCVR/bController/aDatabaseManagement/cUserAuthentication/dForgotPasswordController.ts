...
const forgotPasswordController = (Model=ForgotPasswordModel, Label="ForgotPasswordModel") => ({
  ...
  list: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      cacheCreateMiddleware({ 
        key: cacheVariable.forgotPasswordModel.list({ 
          Label
        }), 
        data: list 
  ...
  create: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      emailToCompanyMiddleware({
        Label,
        data: create,
        textMessage: emailToCompanyVariable.forgotPasswordModel.create({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToUserMiddleware({
        Label,
        data: create,
        textMessage: emailToUserVariable.forgotPasswordModel.create({
          Label, 
          request 
        }),
      })(request, response, next);
  ...
  retrieve: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Create Cache
      cacheCreateMiddleware({ 
        key: cacheVariable.forgotPasswordModel.retrieve({ 
          Label, 
          request 
        }), 
        data: retrieve 
  ...
  update: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Delete Cache
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.forgotPasswordModel.update({ 
          Label, 
          request 
        }), 
      })(request, response, next);
      ...
      eventCreateMiddleware({
        Label,
        data: update,
        eventList: eventVariable.forgotPasswordModel.update({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToCompanyMiddleware({
        Label,
        data: update,
        textMessage: emailToCompanyVariable.forgotPasswordModel.update({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToUserMiddleware({
        Label,
        data: update,
        textMessage: emailToUserVariable.forgotPasswordModel.update({
          Label, 
          request 
        }),
      })(request, response, next);
  ...
  delete: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Delete Cache
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.forgotPasswordModel.delete({ 
          Label, 
          request 
        }), 
      })(request, response, next);
      ...
      eventCreateMiddleware({
        Label,
        data: delete_object,
        eventList: eventVariable.forgotPasswordModel.delete({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToCompanyMiddleware({
        Label,
        data: delete_object,
        textMessage: emailToCompanyVariable.forgotPasswordModel.delete({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToUserMiddleware({
        Label,
        data: delete_object,
        textMessage: emailToUserVariable.forgotPasswordModel.delete({
          Label, 
          request 
        }),
      })(request, response, next);
