...
const adminProjectGroupController = (Model=AdminProjectGroupModel, Label="AdminProjectGroupModel") => ({
  // List Controller
  list: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      cacheCreateMiddleware({ 
        key: cacheVariable.adminProjectGroupModel.list({ 
          Label
        }), 
        data: list 
  ...
  create: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      emailToCompanyMiddleware({
        Label,
        data: create,
        textMessage: emailToCompanyVariable.adminProjectGroupModel.create({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToUserMiddleware({
        Label,
        data: create,
        textMessage: emailToUserVariable.adminProjectGroupModel.create({
          Label, 
          request 
        }),
      })(request, response, next);
  ...
  retrieve: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Create Cache
      cacheCreateMiddleware({ 
        key: cacheVariable.adminProjectGroupModel.retrieve({ 
          Label, 
          request 
        }), 
        data: retrieve 
  ...
  update: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Delete Cache
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.adminProjectGroupModel.update({ 
          Label, 
          request 
        }), 
      })(request, response, next);
      ...
      eventCreateMiddleware({
        Label,
        data: update,
        eventList: eventVariable.adminProjectGroupModel.update({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToCompanyMiddleware({
        Label,
        data: update,
        textMessage: emailToCompanyVariable.adminProjectGroupModel.update({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToUserMiddleware({
        Label,
        data: update,
        textMessage: emailToUserVariable.adminProjectGroupModel.update({
          Label, 
          request 
        }),
      })(request, response, next);
  ...
  delete: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Delete Cache
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.adminProjectGroupModel.delete({ 
          Label, 
          request 
        }), 
      })(request, response, next);
      ...
      eventCreateMiddleware({
        Label,
        data: delete_object,
        eventList: eventVariable.adminProjectGroupModel.delete({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToCompanyMiddleware({
        Label,
        data: delete_object,
        textMessage: emailToCompanyVariable.adminProjectGroupModel.delete({
          Label, 
          request 
        }),
      })(request, response, next);
      ...
      emailToUserMiddleware({
        Label,
        data: delete_object,
        textMessage: emailToUserVariable.adminProjectGroupModel.delete({
          Label, 
          request 
        }),
      })(request, response, next);
  ...
  listMini: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Create Cache
      cacheCreateMiddleware({ 
        key: cacheVariable.adminProjectGroupModel.listMini({ 
          Label
        }), 
        data: list 
      })(request, response, next);
...
export default adminProjectGroupController;
