...
import { PolicyModel } from '../../../aModel/admin/cMain/aPolicyModel';


const policyController = (Model=PolicyModel, Label="Policy") => ({
  // List
  ...
  create: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      const create = await Model.create({
        ...
        dPolicyNumber: request.body.dPolicyNumber,
        dPolicyType: request.body.dPolicyType,
        dPolicyStartDate: request.body.dPolicyStartDate,
        dPolicyEndDate: request.body.dPolicyEndDate,
        dPremiumAmount: request.body.dPremiumAmount,
        dDeductibleAmount: request.body.dDeductibleAmount,
        dCoverageDetails: request.body.dCoverageDetails,
      })
