                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 text-[13px] mt-0.5">New York, NY 10001</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 text-[13px]">+1 (555) 123-4567</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 text-[13px]">contact@business.com</p>
                      </div>
                    </div>
                  </div>
                </div>
