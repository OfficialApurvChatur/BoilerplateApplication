...
const routeList: RouteProps[] = [
  ...
  {
    href: fullRoute.aGlobalRoute.aUnprotectedRoute.bAboutPageRoute,
    label: "About",
  },
  {
    href: fullRoute.aGlobalRoute.aUnprotectedRoute.cContactPageRoute,
    label: "Contact",
  },
];
              ...
              <DropdownMenuContent align="end">
                {
                  (props.ReduxCall.state.receivedObject?.AccountRetrieve?.eAccountStatus === "Verified" && props.ReduxCall.state.receivedObject?.AccountRetrieve?._id) ? (
                    <DropdownMenuGroup>
                      ...
                      <DropdownMenuItem asChild >
                        <span onClick={() => props.submitHandler(props.ReduxCall, props.APICall, navigate)} >
                          <LogOut /> Sign Out
                        </span>
                      </DropdownMenuItem>
                    </DropdownMenuGroup>
