...
const HeroComponent = (props: HeroComponentType) => {
  ...
  return (
    <React.Fragment>
      ...
      <div className="bg-gradient-to-tl from-muted via-muted to-background">
            ...
            <div className="grid lg:grid-cols-2 justify-center items-center gap-x-12 gap-y-16">
              <div>
                <div className="max-w-3xl max-lg:mx-auto max-lg:text-center">
                  ...
                  <h1 className="md:text-5xl text-4xl font-bold !leading-relaxed uppercase">{apiResponse.aTitle}</h1>
                  <h2 className="md:text-2xl text-xl text-muted-foreground leading-relaxed tracking-wide mt-2">{apiResponse.aSubtitle}</h2>
                  <p className="text-muted-foreground text-base leading-relaxed mt-6">{apiResponse.aDescription}</p>
