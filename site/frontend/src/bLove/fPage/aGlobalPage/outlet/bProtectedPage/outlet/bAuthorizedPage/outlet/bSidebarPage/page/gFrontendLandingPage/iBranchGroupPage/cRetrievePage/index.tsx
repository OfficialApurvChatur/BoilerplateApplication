...
import BranchGroupRetrieveComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/gFrontendLandingComponent/iBranchGroupComponent/cRetrieveComponent";
...
const BranchGroupRetrievePage = () => {
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.branchGroup, "Retrieve") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* BranchGroupRetrievePage */}
...
export default BranchGroupRetrievePage;
