...
import AdminBranchGroupRetrieveComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/fAdminLandingComponent/iAdminBranchGroupComponent/cRetrieveComponent";
...
const AdminBranchGroupRetrievePage = () => {
  // Variable
  const { id } = useParams();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.adminBranchGroup, "Retrieve") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* AdminBranchGroupRetrievePage */}
...
export default AdminBranchGroupRetrievePage;
