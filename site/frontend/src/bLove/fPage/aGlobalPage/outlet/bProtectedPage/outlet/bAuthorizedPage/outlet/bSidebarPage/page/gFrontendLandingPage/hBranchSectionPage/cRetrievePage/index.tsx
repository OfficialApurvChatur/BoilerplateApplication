...
import BranchSectionRetrieveComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/gFrontendLandingComponent/hBranchSectionComponent/cRetrieveComponent";
...
const BranchSectionRetrievePage = () => {
  // Variable
  const { id } = useParams();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.branchSection, "Retrieve") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* BranchSectionRetrievePage */}
...
export default BranchSectionRetrievePage;
