...
import AdminHeroRetrieveComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/fAdminLandingComponent/aAdminHeroComponent/cRetrieveComponent";
...
const AdminHeroRetrievePage = () => {
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.adminHero, "Retrieve") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* AdminHeroRetrievePage */}
