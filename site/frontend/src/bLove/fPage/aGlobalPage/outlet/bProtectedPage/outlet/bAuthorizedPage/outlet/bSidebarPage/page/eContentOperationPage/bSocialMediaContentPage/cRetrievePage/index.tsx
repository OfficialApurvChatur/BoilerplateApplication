...
import SocialMediaContentRetrieveComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/eContentOperationComponent/bSocialMediaContentComponent/cRetrieveComponent";
...
const SocialMediaContentRetrievePage = () => {
  // Variable
  const { id } = useParams();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.socialMediaContent, "Retrieve") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* SocialMediaContentRetrievePage */}
...
export default SocialMediaContentRetrievePage;
