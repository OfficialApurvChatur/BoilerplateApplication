...
import AdminProjectUpdateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/fAdminLandingComponent/mAdminProjectComponent/dUpdateComponent";
...
const AdminProjectUpdatePage = () => {
  ...
  const [ updateAPITrigger, updateAPIResponse ] = adminProjectAPIEndpoint.useAdminProjectUpdateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.adminProject, "Update") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* AdminProjectUpdatePage */}
      <AdminProjectUpdateComponent 
