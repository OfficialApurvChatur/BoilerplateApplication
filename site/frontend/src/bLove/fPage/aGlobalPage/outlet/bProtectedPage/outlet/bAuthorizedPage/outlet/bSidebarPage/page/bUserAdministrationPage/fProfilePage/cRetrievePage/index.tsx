...
import ProfileRetrieveComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/bUserAdministrationComponent/fProfileComponent/cRetrieveComponent";
...
const ProfileRetrievePage = () => {
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.profile, "Retrieve") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* ProfileRetrievePage */}
