...
import ContactFormRetrieveComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/gFrontendLandingComponent/dContactFormComponent/cRetrieveComponent";
...
const ContactFormRetrievePage = () => {
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.contactForm, "Retrieve") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* ContactFormRetrievePage */}
...
export default ContactFormRetrievePage;
