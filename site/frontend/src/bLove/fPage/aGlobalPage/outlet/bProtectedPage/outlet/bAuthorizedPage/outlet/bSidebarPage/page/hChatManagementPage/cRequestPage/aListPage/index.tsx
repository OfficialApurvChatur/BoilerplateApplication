...
import RequestListComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/hChatManagement/cRequestComponent/aListComponent";
...
const RequestListPage = () => {
  ...
  const listAPIResponse = requestAPIEndpoint.useRequestListAPIQuery(null);
  ...
  useSocketEventHook(socket, {
    REQUEST_LISTED: () => apiCall.listAPIResponse.refetch()
  })
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.request, "List") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* RequestListPage */}
