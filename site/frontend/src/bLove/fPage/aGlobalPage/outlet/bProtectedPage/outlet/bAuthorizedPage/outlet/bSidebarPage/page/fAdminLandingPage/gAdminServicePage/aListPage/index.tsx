...
import AdminServiceListComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/fAdminLandingComponent/gAdminServiceComponent/aListComponent";
...
const AdminServiceListPage = () => {
  ...
  const listAPIResponse = adminServiceAPIEndpoint.useAdminServiceListAPIQuery(null);
  ...
  useSocketEventHook(socket, {
    ADMINSERVICE_LISTED: () => apiCall.listAPIResponse.refetch()
  })
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.adminService, "List") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
