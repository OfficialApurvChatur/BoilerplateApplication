...
import RequestDeleteComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/hChatManagement/cRequestComponent/eDeleteComponent";
...
const RequestDeletePage = () => {
  ...
  const [ deleteAPITrigger, deleteAPIResponse ] = requestAPIEndpoint.useRequestDeleteAPIMutation();
  ...
  useSocketEventHook(socket, {
    [`REQUEST_RETRIEVED:${id}`]: () => apiCall.retrieveAPIResponse.refetch()
  })
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.request, "Delete") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* RequestDeletePage */}
