...
import HeroListComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/gFrontendLandingComponent/aHeroComponent/aListComponent";
...
const HeroListPage = () => {
  ...
  const listAPIResponse = heroAPIEndpoint.useHeroListAPIQuery(null);
  ...
  useSocketEventHook(socket, {
    HERO_LISTED: () => apiCall.listAPIResponse.refetch()
  })
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.hero, "List") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* HeroListPage */}
      <HeroListComponent 
