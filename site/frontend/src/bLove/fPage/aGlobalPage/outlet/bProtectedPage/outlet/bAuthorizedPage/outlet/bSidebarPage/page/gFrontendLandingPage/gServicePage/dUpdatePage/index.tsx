...
import ServiceUpdateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/gFrontendLandingComponent/gServiceComponent/dUpdateComponent";
...
const ServiceUpdatePage = () => {
  ...
  const [ updateAPITrigger, updateAPIResponse ] = serviceAPIEndpoint.useServiceUpdateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.service, "Update") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* ServiceUpdatePage */}
