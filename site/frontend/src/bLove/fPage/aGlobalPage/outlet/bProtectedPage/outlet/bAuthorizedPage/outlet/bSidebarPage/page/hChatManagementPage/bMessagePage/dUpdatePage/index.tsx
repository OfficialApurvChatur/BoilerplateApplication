...
import MessageUpdateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/hChatManagement/bMessageComponent/dUpdateComponent";
...
const MessageUpdatePage = () => {
  ...
  const [ updateAPITrigger, updateAPIResponse ] = messageAPIEndpoint.useMessageUpdateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.message, "Update") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* MessageUpdatePage */}
