...
import BranchUpdateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/gFrontendLandingComponent/jBranchComponent/dUpdateComponent";
...
const BranchUpdatePage = () => {
  ...
  const [ updateAPITrigger, updateAPIResponse ] = branchAPIEndpoint.useBranchUpdateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.branch, "Update") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* BranchUpdatePage */}
