...
import UserDeleteComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/bUserAdministrationComponent/eUserComponent/eDeleteComponent";
...
const UserDeletePage = () => {
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.user, "Delete") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* UserDeletePage */}
      <UserDeleteComponent
