...
import ServiceListComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/gFrontendLandingComponent/gServiceComponent/aListComponent";
...
const ServiceListPage = () => {
  ...
  const listAPIResponse = serviceAPIEndpoint.useServiceListAPIQuery(null);
  ...
  useSocketEventHook(socket, {
    SERVICE_LISTED: () => apiCall.listAPIResponse.refetch()
  })
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.service, "List") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* ServiceListPage */}
