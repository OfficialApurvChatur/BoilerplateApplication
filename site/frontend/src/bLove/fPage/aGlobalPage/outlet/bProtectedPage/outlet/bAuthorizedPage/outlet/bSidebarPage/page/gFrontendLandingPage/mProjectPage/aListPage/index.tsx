...
import ProjectListComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/gFrontendLandingComponent/mProjectComponent/aListComponent";
...
const ProjectListPage = () => {
  ...
  const listAPIResponse = projectAPIEndpoint.useProjectListAPIQuery(null);
  ...
  useSocketEventHook(socket, {
    PROJECT_LISTED: () => apiCall.listAPIResponse.refetch()
  })
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.project, "List") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* ProjectListPage */}
