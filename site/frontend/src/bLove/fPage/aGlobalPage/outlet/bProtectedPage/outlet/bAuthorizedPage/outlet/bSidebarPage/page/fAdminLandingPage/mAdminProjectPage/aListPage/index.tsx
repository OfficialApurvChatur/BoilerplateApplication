...
import AdminProjectListComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/fAdminLandingComponent/mAdminProjectComponent/aListComponent";
...
const AdminProjectListPage = () => {
  ...
  const listAPIResponse = adminProjectAPIEndpoint.useAdminProjectListAPIQuery(null);
  ...
  useSocketEventHook(socket, {
    ADMINPROJECT_LISTED: () => apiCall.listAPIResponse.refetch()
  })
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.adminProject, "List") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
