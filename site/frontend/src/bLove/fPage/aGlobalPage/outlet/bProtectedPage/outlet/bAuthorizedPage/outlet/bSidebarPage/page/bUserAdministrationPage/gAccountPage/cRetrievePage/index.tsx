...
import AccountRetrieveComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/bUserAdministrationComponent/gAccountComponent/cRetrieveComponent";
...
const AccountRetrievePage = () => {
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.account, "Retrieve") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* AccountRetrievePage */}
