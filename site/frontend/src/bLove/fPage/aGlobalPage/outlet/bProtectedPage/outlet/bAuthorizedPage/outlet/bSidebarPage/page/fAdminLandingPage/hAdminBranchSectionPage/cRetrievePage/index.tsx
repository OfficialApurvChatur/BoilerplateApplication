...
import AdminBranchSectionRetrieveComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/fAdminLandingComponent/hAdminBranchSectionComponent/cRetrieveComponent";
...
const AdminBranchSectionRetrievePage = () => {
  // Variable
  const { id } = useParams();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.adminBranchSection, "Retrieve") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* AdminBranchSectionRetrievePage */}
...
export default AdminBranchSectionRetrievePage;
