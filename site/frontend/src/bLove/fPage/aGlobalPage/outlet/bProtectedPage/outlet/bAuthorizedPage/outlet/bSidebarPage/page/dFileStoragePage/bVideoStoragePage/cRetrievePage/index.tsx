...
import VideoStorageRetrieveComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/dFileStorageComponent/bVideoStorageComponent/cRetrieveComponent";
...
const VideoStorageRetrievePage = () => {
  // Variable
  const { id } = useParams();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.videoStorage, "Retrieve") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* VideoStorageRetrievePage */}
...
export default VideoStorageRetrievePage;
