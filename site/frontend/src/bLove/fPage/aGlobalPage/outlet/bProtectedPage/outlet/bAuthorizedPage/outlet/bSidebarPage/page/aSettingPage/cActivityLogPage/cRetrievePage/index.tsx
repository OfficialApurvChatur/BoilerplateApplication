...
import activityLogAPIEndpoint from "@/bLove/aAPI/aGlobalAPI/bProtectedAPI/bAuthorizedAPI/bSidebarAPI/aSettingAPI/cActivityLogAPI";

import ActivityLogRetrieveComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/aSettingComponent/cActivityLogComponent/cRetrieveComponent";
...
const ActivityLogRetrievePage = () => {
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.activityLog, "Retrieve") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
